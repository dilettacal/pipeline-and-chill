#!/usr/bin/env python3
"""
ChillFlow Observatory - Simple Streamlit Dashboard
A lightweight alternative to the complex Prometheus/Grafana stack.
"""
...
st.markdown("**Real-time monitoring for your data pipeline**")
...
tab1, tab2, tab3, tab4 = st.tabs(["📈 Metrics", "📊 Database", "📝 Logs", "🔧 System"])
...
# Footer
st.markdown("---")
st.markdown("🌊 **ChillFlow Observatory** - Simple monitoring for your data pipeline")
